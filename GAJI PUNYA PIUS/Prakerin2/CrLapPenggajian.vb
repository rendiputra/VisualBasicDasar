...
Public Class CrLapPenggajian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prakerin2.CrLapPenggajian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLapPenggajian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLapPenggajian = New CrLapPenggajian()
        rpt.Site = Me.Site
        Return rpt
    End Function
