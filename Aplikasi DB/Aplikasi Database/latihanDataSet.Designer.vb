...
Partial Public Class latihanDataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal NAMA As String, ByVal ALAMAT As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, NAMA, ALAMAT}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByNIP(ByVal NIP As Integer) As Table1Row
            Return CType(Me.Rows.Find(New Object() {NIP}),Table1Row)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnNIP.AutoIncrement = true
            Me.columnNIP.AutoIncrementSeed = -1
            Me.columnNIP.AutoIncrementStep = -1
    ...
    Partial Public Class Table1Row
        ...
        Public Property NIP() As Integer
            Get
                Return CType(Me(Me.tableTable1.NIPColumn),Integer)
            End Get
            Set
                Me(Me.tableTable1.NIPColumn) = value
            End Set
        End Property
...
Namespace latihanDataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`NIP` = ?) AND ((? = 1 AND `NAMA` IS NULL) OR (`NAMA"& _ 
                "` = ?)) AND ((? = 1 AND `ALAMAT` IS NULL) OR (`ALAMAT` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_NIP", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NIP", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`NAMA`, `ALAMAT`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `NAMA` = ?, `ALAMAT` = ? WHERE ((`NIP` = ?) AND ((? = 1 AND `"& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_NIP", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NIP", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Aplikasi_Database.My.MySettings.Default.latihanConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT NIP, NAMA, ALAMAT FROM Table1"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As latihanDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As latihanDataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As latihanDataSet.Table1DataTable = New latihanDataSet.Table1DataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As latihanDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_NIP As Integer, ByVal Original_NAMA As String, ByVal Original_ALAMAT As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal NAMA As String, ByVal ALAMAT As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal NAMA As String, ByVal ALAMAT As String, ByVal Original_NIP As Integer, ByVal Original_NAMA As String, ByVal Original_ALAMAT As String) As Integer
            If (NAMA Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Original_NIP,Integer)
            If (Original_NAMA Is Nothing) Then
